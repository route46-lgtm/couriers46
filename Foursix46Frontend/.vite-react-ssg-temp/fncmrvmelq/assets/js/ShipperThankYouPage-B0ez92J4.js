                ...
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("p", { children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsx("span", { className: "font-bold text-[#48AEDD]", children: "Join Our Courier Network" }),
                      "."
                    ] }),
                    /* @__PURE__ */ jsx("p", { children: "Our team is currently reviewing your information, and we will contact you soon to guide you through setting up your business account." }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 text-base bg-[#F5EB18]/10 py-3 px-6 rounded-full w-fit mx-auto mt-6 border border-[#F5EB18]/20", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "font-medium text-[#134467]", children: "If any details are needed, we’ll reach out directly." })
                    ] })
                  ]
                }
              )
...
export {
  ShipperThankYouPage as default
};
