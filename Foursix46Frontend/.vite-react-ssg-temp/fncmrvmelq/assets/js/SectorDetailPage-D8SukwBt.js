...
import { ArrowLeft, Timer, Globe, Zap, Truck, MapPin, CheckCircle2, Layers, ArrowRight, Clock, Navigation, Network } from "lucide-react";
...
async function loader({ params }) {
  ...
  try {
    ...
    return {
      sector: (sectorData == null ? void 0 : sectorData.data) || sectorData || null,
...
function SectorDetailPage() {
  ...
  useEffect(() => {
    var _a2;
    if (!((_a2 = sector == null ? void 0 : sector.faqIds) == null ? void 0 : _a2.length)) return;
    (async () => {
      try {
        ...
        setFaqs(all.filter((f) => sector.faqIds.includes(f.id)));
      } catch {
      }
    })();
  }, [sector]);
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-white", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-5", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-[#134467]/50 text-sm font-semibold tracking-widest uppercase", children: "Loading sector details..." })
    ] }) });
  }
  if (!sector || sector.status !== "published") {
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex flex-col items-center justify-center gap-6 bg-slate-50 px-5 text-center antialiased", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-[#134467] tracking-tight", children: "Sector Not Found" }),
        /* @__PURE__ */ jsx("p", { className: "text-[#134467]/50 mt-2 font-medium text-sm", children: "This sector doesn't exist or may have been removed." })
      ] }),
      /* @__PURE__ */ jsxs(
        "button",
        {
  ...
  const heroImage = !imgError && sector.heroImage ? sector.heroImage : "/route462.jpeg";
  ...
  const featuredLocations = sector.featuredLocations || [];
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white selection:bg-[#E53935] selection:text-white antialiased", children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      /* @__PURE__ */ jsxs("title", { children: [
        sector.seoTitle || sector.name,
        " | FourSix46®"
      ] }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: sector.seoDescription || "" }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: canonicalUrl }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: sector.seoTitle || sector.name }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: sector.seoDescription || "" }),
      ...
      /* @__PURE__ */ jsx(
        ...
        {
          property: "og:image",
          content: sector.ogImage || "https://www.route46couriers.co.uk/og-default.jpg"
        }
      ),
      sector.noindex && /* @__PURE__ */ jsx("meta", { name: "robots", content: "noindex,nofollow" }),
      ...
      /* @__PURE__ */ jsx("script", { type: "application/ld+json", children: JSON.stringify({
        ...
        image: sector.ogImage || "https://www.route46couriers.co.uk/og-default.jpg",
        description: sector.seoDescription || "",
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { children: "All Sectors" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 w-full max-w-5xl mx-auto px-5 sm:px-8 pb-20 sm:pb-24 pt-36 sm:pt-32", children: [
        ...
        /* @__PURE__ */ jsx(
          "h1",
          {
            ...
            children: sector.heroTitle || sector.name
          }
        ),
        sector.heroSubtitle && /* @__PURE__ */ jsx(
          "p",
          {
            className: cn(
    ...
    sector.intro && /* @__PURE__ */ jsxs("section", { className: "max-w-3xl mx-auto py-16 sm:py-20 px-5 sm:px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        /* @__PURE__ */ jsx("div", { className: "w-1.5 h-10 rounded-full bg-gradient-to-b from-[#E53935] to-[#48AEDD]" }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-black uppercase tracking-[0.2em] text-[#48AEDD]", children: "About This Sector" })
      ] }),
      /* @__PURE__ */ jsx(
        "div",
        {
    ...
    ((_a = sector.contentBlocks) == null ? void 0 : _a.length) > 0 && /* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsx(BlockRenderer, { blocks: sector.contentBlocks }) }),
    ...
    faqs.length > 0 && /* @__PURE__ */ jsx("section", { className: "py-20 sm:py-24 bg-slate-50 border-t border-slate-100", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-5 sm:px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-4xl font-black text-[#134467] tracking-tight leading-tight", children: sector.faqHeading || "Sector FAQs" }),
        /* @__PURE__ */ jsx("p", { className: "mt-3 text-[#134467]/50 text-sm font-medium", children: "Everything you need to know about this sector." })
      ] }),
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-[#134467] py-20 sm:py-24 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center px-5 sm:px-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsx(Layers, { className: "w-5 h-5 text-[#48AEDD]" }),
          /* @__PURE__ */ jsx("span", { className: "text-[#48AEDD] text-sm font-bold uppercase tracking-widest", children: sector.name })
        ] }),
        /* @__PURE__ */ jsx("h2", { className: "text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight mb-4", children: "Need a courier for your sector?" }),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "px-2 pt-4 pb-2", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
            ...
            /* @__PURE__ */ jsx("h3", { className: "font-black text-[15px] text-[#134467] leading-snug tracking-tight capitalize group-hover:text-[#E53935] transition-colors duration-200", children: name })
          ] }),
