...
import { Search, BookOpen, ArrowRight, Timer, Map, Zap, Clock, MapPin, Network } from "lucide-react";
...
function ServicesPage() {
  ...
  useEffect(() => {
    async function loadServices() {
      try {
        ...
        setServices(
          [...data].filter((s) => s.status === "published").sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0))
        );
      } catch (err) {
  ...
  const filteredServices = services.filter(
    (s) => {
      var _a, _b, _c;
      return search ? ((_a = s.name) == null ? void 0 : _a.toLowerCase().includes(search.toLowerCase())) || ((_b = s.seoDescription) == null ? void 0 : _b.toLowerCase().includes(search.toLowerCase())) || ((_c = s.heroSubtitle) == null ? void 0 : _c.toLowerCase().includes(search.toLowerCase())) : true;
    }
  );
  if (loading) {
    return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center bg-white", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-5", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-[#134467]/50 text-sm font-semibold tracking-widest uppercase", children: "Loading services…" })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-white font-sans antialiased", children: [
    /* @__PURE__ */ jsxs(Helmet, { children: [
      /* @__PURE__ */ jsx("title", { children: "Our Services | Route46" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "description",
      ...
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Our Services | Route46" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
    ...
    /* @__PURE__ */ jsxs("section", { className: "relative pt-20 pb-24 text-center overflow-hidden bg-white", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-[600px] h-[600px] bg-[#48AEDD]/6 rounded-full blur-3xl -z-10 -translate-y-1/2 translate-x-1/4" }),
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#E53935]/5 rounded-full blur-3xl -z-10 translate-y-1/2 -translate-x-1/4" }),
      /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-6", children: [
        /* @__PURE__ */ jsx("span", { className: "inline-block text-[11px] font-black uppercase tracking-[0.2em] text-[#134467] bg-[#F5EB18] px-5 py-2 rounded-full mb-7 shadow-sm", children: "Express Delivery Across the UK" }),
        /* @__PURE__ */ jsxs("h1", { className: "text-5xl md:text-6xl lg:text-7xl font-black text-[#48AEDD] leading-[1.06] tracking-tight mb-6", children: [
          "Our",
          " ",
          /* @__PURE__ */ jsxs("span", { className: "relative inline-block text-[#E53935]", children: [
            "Services",
            /* @__PURE__ */ jsx("span", { className: "absolute -bottom-1 left-0 w-full h-1.5 bg-[#F5EB18] rounded-full" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-[#134467]/65 max-w-2xl mx-auto leading-[1.85] font-medium", children: "Explore our specialist courier services designed for urgent deliveries, confidential documents, and time-critical logistics across the UK." })
      ] })
    ] }),
    /* @__PURE__ */ jsx("section", { className: "container mx-auto px-6 pb-10 max-w-lg", children: /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "container mx-auto px-6 pb-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto grid gap-7", children: [
      filteredServices.length === 0 && /* @__PURE__ */ jsxs("div", { className: "text-center py-20", children: [
        /* @__PURE__ */ jsx(BookOpen, { className: "w-12 h-12 mx-auto text-slate-200 mb-4" }),
        /* @__PURE__ */ jsx("p", { className: "text-[#134467]/40 font-semibold text-lg tracking-wide", children: search ? `No services found for "${search}"` : "No services available" })
      ] }),
      filteredServices.map((service, index) => /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-[5fr_8fr] items-stretch", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative h-56 md:h-auto bg-slate-100 overflow-hidden min-h-[200px]", children: [
              service.heroImage || service.featuredImage ? /* @__PURE__ */ jsx(
                "img",
                {
                  ...
                  onError: (e) => {
                    e.target.src = "/route462.jpeg";
                  }
                }
              ) : /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gradient-to-br from-[#134467] via-[#1a5280] to-[#48AEDD] flex items-center justify-center", children: /* @__PURE__ */ jsx(BookOpen, { className: "w-14 h-14 text-white/15" }) }),
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent to-black/5 md:hidden" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "p-8 md:p-10 lg:p-12 flex flex-col justify-center gap-4", children: [
              /* @__PURE__ */ jsx("span", { className: "inline-block w-fit text-[10px] font-black uppercase tracking-[0.18em] text-[#134467] bg-[#F5EB18] px-3.5 py-1.5 rounded-full shadow-sm", children: "Courier Service" }),
              /* @__PURE__ */ jsxs("h2", { className: "text-2xl md:text-3xl font-black text-[#134467] group-hover:text-[#E53935] transition-colors duration-200 flex items-center gap-3 leading-tight tracking-tight", children: [
                service.name,
                /* @__PURE__ */ jsx(ArrowRight, { className: "text-[#E53935] w-5 h-5 flex-shrink-0 group-hover:translate-x-2 transition-transform duration-300" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-[#134467]/60 text-[15px] leading-[1.85] font-medium line-clamp-3", children: service.heroSubtitle || service.seoDescription || "Click to view full service details and get an instant quote." }),
              /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2 pt-1", children: [
                ...
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Icon, { className: "w-3.5 h-3.5 text-[#48AEDD]" }),
                    label
                  ]
                },
                label
    ...
    /* @__PURE__ */ jsxs("section", { className: "bg-[#134467] py-24 relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-[600px] h-[600px] bg-[#48AEDD]/10 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#E53935]/10 rounded-full blur-3xl pointer-events-none" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsx("span", { className: "inline-block text-[11px] font-black uppercase tracking-[0.2em] bg-[#F5EB18] text-[#134467] px-5 py-2 rounded-full mb-5 shadow-sm", children: "Trusted UK Courier Network" }),
          /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight", children: "How Our Courier Network Works" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:gap-4", children: HOW_IT_WORKS.map((item, i) => /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "py-24 bg-white text-center relative overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[radial-gradient(ellipse_at_center,_#48AEDD08_0%,_transparent_70%)]" }),
      /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-2xl mx-auto px-6", children: [
        /* @__PURE__ */ jsx("p", { className: "text-[11px] font-black uppercase tracking-[0.22em] text-[#134467]/40 mb-3", children: "Route46 Couriers" }),
        /* @__PURE__ */ jsx("p", { className: "text-[#134467]/55 text-base font-medium leading-[1.8] mb-8", children: "Route46 Couriers provides reliable same-day transport across the UK with access to thousands of verified drivers and vehicles through our extended courier network, ensuring fast collection, secure handling, and true nationwide delivery coverage." }),
        /* @__PURE__ */ jsxs(
          "button",
          {
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-slate-50/80 py-24 border-t border-slate-100", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center mb-14", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-3xl md:text-4xl lg:text-5xl font-black text-[#134467] tracking-tight leading-tight mb-4", children: "Why Choose Route46 Couriers" }),
