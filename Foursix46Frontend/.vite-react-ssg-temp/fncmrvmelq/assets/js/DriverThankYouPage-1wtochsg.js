              ...
              /* @__PURE__ */ jsxs(
                motion.h1,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("span", { className: "text-[#E53935]", children: " Received" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("p", { className: "text-[#134467]/80 leading-relaxed", children: [
                      "Thank you for applying to become a courier driver with",
                      " ",
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "mt-4 bg-slate-50 border border-slate-100 rounded-2xl p-5 text-left", children: [
                      /* @__PURE__ */ jsx("h3", { className: "text-sm font-black text-[#134467] uppercase tracking-widest mb-3", children: "What happens next?" }),
                      /* @__PURE__ */ jsx("ul", { className: "space-y-2.5", children: [
                        "Our team will review your application details.",
                        "If everything looks good, we may contact you to verify documents.",
                        "Once approved, you'll receive instructions on how to start accessing courier delivery opportunities."
                      ].map((step, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-2.5", children: [
                        /* @__PURE__ */ jsx(
                          "span",
                          {
                            className: "mt-0.5 w-5 h-5 rounded-full bg-[#48AEDD]/10 text-[#48AEDD]\n          text-xs font-black flex items-center justify-center flex-shrink-0",
                            children: i + 1
                          }
                        ),
                        /* @__PURE__ */ jsx("span", { className: "text-sm text-[#134467]/75 font-medium leading-relaxed", children: step })
                      ] }, i)) })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-3 text-base bg-[#F5EB18]/10 py-3 px-6 rounded-full w-fit mx-auto mt-6 border border-[#F5EB18]/20", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "font-medium text-[#134467]", children: "Our driver onboarding team will contact you if additional information is required." })
                    ] })
                  ]
                }
              )
